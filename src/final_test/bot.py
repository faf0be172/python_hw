...
def start(update, context: CallbackContext):
    context.bot.send_message(
        chat_id=update.effective_chat.id, text="This bot can paint your black-white .jpeg pictures, just try it."
    )
...
def paint_image(update, context: CallbackContext):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Wait a moment, picture is processing...")
